...
echo "9.1" >> $CONF_IN # Please specify the CUDA SDK version you want to use
echo $CRAY_CUDATOOLKIT_DIR >> $CONF_IN # Please specify the CUDA SDK version you want to use
echo "7.1.4" >> $CONF_IN # Please specify the cuDNN version you want to use.
...
echo "2.2.13" >> $CONF_IN # Please specify the NCCL version you want to use.
