...
##
"""
cpeGNU toolchain: GCC and MPI via Cray compiler drivers + LibSci and Cray FFTW (cpe-gnu)
...
class cpeGNU(CrayPEGCC, CrayMPICH, LibSci):
    """Compiler toolchain for Shasta Cray Programming Environment for GCC compilers (cpe-gnu)."""
    NAME = 'cpeGNU'
