...
##
"""
EasyBuild support for building and installing Arm tools, implemented as an easyblock
...
class EB_Arm(Binary):
    """Support for building/installing Arm."""

    @staticmethod
    def extra_options(extra_vars=None):
        """Define extra easyconfig parameters specific to Arm."""
    ...
    def sanity_check_step(self):
        """Custom sanity check for Arm."""
        custom_paths = {
            'files': ['bin/ddt', 'bin/map'],
            'dirs': [],
        }
        super(EB_Arm, self).sanity_check_step(custom_paths=custom_paths)
